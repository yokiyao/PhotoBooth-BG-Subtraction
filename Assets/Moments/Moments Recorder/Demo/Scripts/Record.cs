...
public class Record : MonoBehaviour
{
	...
	void Start()
	{
		...
		m_Recorder.OnProcessingDone = OnProcessingDone;
    ...
    public void StartRecordingGif(string gifFilePath, string encodedFileName)
    {
        m_Recorder.Save(gifFilePath, encodedFileName);
        m_Progress = 0f;
    }
